---
description: Portfolio PM agent. Use when Dave asks what to work on today, wants to plan epics or user stories, or needs to initialize product docs for a project. Trigger phrases — "what should I work on", "plan my day", "write an epic", "init project docs".
---
