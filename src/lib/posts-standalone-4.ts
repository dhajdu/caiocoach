...
export const BLOCKS_STANDALONE_4: Record<string, Block[]> = {
  'founder-built-product-5-days-instead-3-months': [
    ...
    { tag: 'image', src: '/blog/images/founder-built-james-coding.webp', alt: 'James coding at the dinner table during the five-day Vietnam sprint', caption: 'James can\'t stop coding at dinner.' },
    ...
    { tag: 'image', src: '/blog/images/founder-built-team-selfie.webp', alt: 'James with the Vietnam team at the end of the five-day sprint', caption: 'The team at the end of day five. 70 percent shipped, 30 percent to polish.' },
